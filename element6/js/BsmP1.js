d3.csv("csv/culled/bsm_p1.csv", function (error, data) {
    ...
    function bsmp1() {
        ...
        var testpaths = function (data, width) {
                ...
                //colores not used right now- just fore keying
                ...
                //context axis now below brush call
                ...
                var renderingbits = function (width, height) {
                        ...
                        setTimeout(function () {
                            eventrows.each(function (d, i) {
                                ...
                                //sparkSVG.attr("clip-path", function (d) { return "url(#BsmPclip" + i + ")" });

                                //commented out to test clip mask on just the path since losing y axis
    ...
    //                                .duration(900)
                        ...
                        function drawBrush() {                  
                            ...
                            //new extent for better view
                            // BsmPbrush.extent([timeBegin, parsedExtent]);
                        ...
                        //  BsmPcontextxaxis.moveToBack();
//                        d3.selectAll("#BsmP1 .context .resize path").moveToFront();
