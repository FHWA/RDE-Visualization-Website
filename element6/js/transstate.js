d3.csv("csv/TransStateEvents_04_11_13.csv", function (error, data) {
    ...
    var transstate = function (data) {
            ...
            //don't need y axis on this one

            //        var showStart = d3.select("#bb1field")
            //            .append("div")
            //            .attr("class", "updatedField")
            //            .html(timeBegin);
            //
            //        var showEnd = d3.select("#bb1field")
            //            .append("div")
            //            .attr("class", "updatedField")
            //            .html(timeEnd);
            ...
            var renderingbits = function (width, height) {
                    ...
                    //var m = [20, 0,40, 0], //top right bottom left
                    w = width - m[1] - m[3],
                        h = height - m[0] - m[2];
...
//                    contextxaxis
//                        .attr("transform", "translate(" + 0 + "," + (m[2] - 10) + ")")
//                        .call(xAxis2);
                 ...
                 contextxaxis
                    ...
                    function drawBrush() {
                        ...
                        //                        
                        //                          transbrush(d3.select("#TransStateEvents .brush").transition());
                        //            
                        //                        transbrush.event(d3.select("#TransStateEvents .brush").transition().duration(1))
