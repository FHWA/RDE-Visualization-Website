...
// console.log(items);
    ...
    var y = d3.scale.linear()
        .range([h, 0])
        //            .domain(d3.extent(items.map(function(d) {
        //                return d.Value;
        //            })))
    ...
    var contextxaxis = context.append("g")
       ...
       var rects = steerchart.append("g")
        ...
        .selectAll("rect")
        //rects = eventrows.selectAll("rect")
        .data(items)
        .enter()
        .append("rect")
    ...
    //            var labels = steerchart.append("text")
  ...
  xAxis.orient("bottom")
            ...
            //to reset brush when resizing chartab
           // d3.selectAll("#steer .x.brush").call(steerbrush.clear());
            ...
            function drawBrush() {
                ...
                //  console.log(parsedExtent);
               // steerbrush.extent([timeBegin, parsedExtent]);
                ...
                steerbrush.event(d3.select("#SteerAngleEvents .brush").transition().duration(1))
                
                //trying this to preserve set view on load
                // x.domain(steerbrush.extent());
            }
            drawBrush();
