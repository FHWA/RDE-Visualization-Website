d3.csv("csv/BSM_Trip_Summary_File_04_11_13.csv", function (error, data) {
        ...
        function tripsumfunct() {
            ...
            var renderingbits = function (width, height) {
                    ...
                    ylabel.attr("transform", "rotate (-90)")
                        ...
                        .attr("dx", -h / 2)
                        //.attr("dy",-100)
                        .text("Total Trip Distance (miles)")
                  ...
                  xlabel.attr("y", -10)
                        ...
                        .attr("text-anchor", "middle");
//                
//                  xunitlabel.attr("y",h + 25)
//                        .attr("x", w/ 2)
//                        //.attr("dy",-100)
//                        .text("full time span ≈ 35min")
//                        .attr("text-anchor", "middle");
...
//                var firstticktext =d3.select(".x.axis .tick text").text();
//                console.log(firstticktext);
                
               // xunitlabel.text(firstticktext);
